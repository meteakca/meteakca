...
format:
  ...
  typst:
    include-in-header: _includes/cv-typst-header.typ
    papersize: us-letter
    filters:
      - _filters/section-kicker-typst.lua
---
...
`Tel` 912.478.0002 · [makcaoglu@georgiasouthern.edu](mailto:makcaoglu@georgiasouthern.edu) · [meteakcaoglu.com](https://meteakcaoglu.com)
...
Professor of instructional technology and department chair at Georgia Southern University. Research spans motivation, interest development, game-based learning, and AI in education — working with K–12 teachers and students using experimental, survey, and qualitative methods.
...
#grid(
  ...
  gutter: 0pt,
  ..( ("28", "h-index"), ("4,923", "Citations"), ("41", "Articles"), ("NSF", "PI Grant · $300K") ).map(((val, lbl)) => box(
    stroke: 0.5pt + rgb("#CCCCCC"),
    inset: 8pt,
    width: 100%,
    align(center)[
      #text(size: 14pt, weight: "bold")[#val]\
      #text(size: 7pt, fill: rgb("#718096"))[#upper(lbl)]
    ]
  ))
)
#v(0.6em)
